...
class VerificationCode(models.Model):
    ...
    Stores OTP in DB with 10-minute expiry.
    """
...
class Banner(models.Model):
    ...
    active = CustomBannerManager()  # Custom manager for filtering active banners
    ...
    def __str__(self) -> str:
        # Note: __str__ should be side-effect free - do NOT call save() here
        return self.title
