...
urlpatterns = [
    ...
    # ML module commented out - will be replaced with AI service in Phase 4
    ...
    path(
        "image/property/create/",
        views.CreatePropertyImageViewsets.as_view({"post": "create"}),
    ),
    path("image/<int:pk>/delete/", views.ImageViewsets.as_view({"delete": "destroy"})),
]
